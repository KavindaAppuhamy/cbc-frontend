...
export default function AddProductPage() {
    ...
    async function AddProduct() {
        ...
        try {
            ...
            const altNamesArray = Array.isArray(altNames)
                ? altNames.map((name) => name.trim()).filter(Boolean)
                : altNames
                    .split(",")
                    .map((name) => name.trim())
                    .filter(Boolean);
            ...
            api.post("/api/products", product)
                ...
                .catch((e) => {
                    toast.error(
                        getErrorMessage(e, "Could not add product.")
                    );
                });
        } catch (e) {
            console.log(e);
    ...
    const inputClass =
        "w-full h-12 rounded-xl border border-slate-200 bg-slate-50/80 px-4 text-sm text-slate-900 outline-none transition-all duration-200 placeholder:text-slate-400 hover:border-slate-300 focus:border-slate-900 focus:bg-white focus:ring-4 focus:ring-slate-900/5";
        ...
        <div className="min-h-screen bg-[#f6f8fb] px-4 py-6 font-sans text-slate-900 sm:px-6 lg:px-8 lg:py-10">
            <div className="mx-auto max-w-6xl">
                ...
                <div className="mb-8 flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between">
                    <div>
                        ...
                        <p className="mt-2 max-w-xl text-sm leading-6 text-slate-500 sm:text-base">
                            Create a polished product listing with images,
                            pricing, inventory and detailed information.
                        </p>
                    </div>
                            ...
                            <div className="mb-6 flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="mt-1 text-sm text-slate-500">
                                        Add the essential information customers
                            ...
                            <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <p className="mt-2 text-xs text-slate-400">
                                        Use a unique identifier for this product.
                                    </p>
                                </div>
                        ...
                        <section>
                            <div className="mb-6 flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="mt-1 text-sm text-slate-500">
                                        Upload high-quality images to showcase
                                        your product.
                                    </p>
                                </div>
                            </div>
                ...
                <div className="mt-5 text-center text-xs text-slate-400">
                    Make sure all product information is accurate before
                    publishing.
                </div>
            </div>
        </div>
